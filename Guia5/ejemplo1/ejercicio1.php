...
$contador = substr_count($text, $palabra);

$text = preg_replace("/(" . $palabra . ")/i", '<span
style="background:#5fc9f6">\1</span>', $text);
 ?>
 <div id="sidebarwrap">
 <h2>Resultado</h2>
 <h3>Cantidad de palabras encontrada: 
    <?php 
    echo $contador;
    ?></h3>
<p><?= $text ?></p>
...
tabindex="4">
 ...
 (abbreviated as regex or regexp, with plural forms regexes, regexps, or regexen) are written in a formal
